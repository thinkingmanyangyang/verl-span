...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/data/yangzhenfei/DisCO/datasets/deepscaler/data/train.parquet \
    data.val_files=/data/yangzhenfei/DisCO/datasets/deepscaler/data/aime.parquet \
