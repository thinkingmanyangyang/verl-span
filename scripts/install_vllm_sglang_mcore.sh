...
# pip install "transformers[hf_xet]>=4.51.0" accelerate  peft hf-transfer "numpy<2.0.0" pandas ray[default] codetiming hydra-core pylatexenc qwen-vl-utils wandb dill pybind11 liger-kernel mathruler pytest py-spy pyext pre-commit ruff

# conda install datasets "pyarrow>=15.0.0"
